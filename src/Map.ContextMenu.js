...
L.Map.ContextMenu = L.Handler.extend({
	...
	initialize: function (map) {
		...
		var mainContainer = L.DomUtil.create('div', L.Map.ContextMenu.BASE_CLS, map._container);
		var container = this._container = L.DomUtil.create('ul', 'dropdown-menu', mainContainer);
	...
	_createItem: function (container, options, index) {
		...
		var itemCls = L.Map.ContextMenu.BASE_CLS + '-item',
		    cls = options.disabled ? (itemCls + ' disabled') : itemCls,
				li = this._insertElementAt('li', cls, container, index)
		    el = L.DomUtil.create('a', '', li),
